...
set(PROJECT_BIN_PATH ${PROJECT_APP_PATH}/usr/bin/smartfi-desktop)
...
file(COPY ${PROJECT_APP_PATH}/usr/share/icons/default/64x64/apps/smartfi-desktop-64.png DESTINATION ${PROJECT_APP_PATH})
file(COPY ${PROJECT_APP_PATH}/usr/share/applications/smartfi-desktop.desktop DESTINATION ${PROJECT_APP_PATH})
...
execute_process(COMMAND zip -r smartfi-desktop-linux-${VERSION_ID}.zip AntaraAtomicDexAppDir
        WORKING_DIRECTORY ${TARGET_APP_PATH}
        ECHO_OUTPUT_VARIABLE
        ECHO_ERROR_VARIABLE)
execute_process(COMMAND tar --zstd -cf smartfi-desktop-linux-${VERSION_ID}.tar.zst AntaraAtomicDexAppDir
        WORKING_DIRECTORY ${TARGET_APP_PATH}
        ECHO_OUTPUT_VARIABLE
        ECHO_ERROR_VARIABLE)
file(COPY ${CMAKE_SOURCE_DIR}/smartfi-desktop-${VERSION_ID}-x86_64.AppImage DESTINATION ${TARGET_APP_PATH})